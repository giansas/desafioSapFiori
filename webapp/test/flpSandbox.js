		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Images search",
									"targetURL": "#googleimages-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"googleimages-display": {
								"semanticObject": "googleimages",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=googleimages",
									"url": sap.ui.require.toUrl("googleimages")
								}
							}
						}
					}
